...
//         params: { ...params, populate: 'owner' } // ✅ Ensure population
//       });
...
// // ✅ Public farmhouses (for browsing)
...
//     try {
//       console.log("Updating farmhouse with data:", data); // Debug log
//       const response = await axiosInstance.put(`/farmhouses/${id}`, data);
//       return response.data.farmhouse;
//     } catch (error) {
//       console.error("Update error:", error.response?.data); // Debug error
...
// // ✅ NEW: Fetch pending farmhouses for admin
...
//       return response.data.farmhouse;
//     } catch (error) {
//       console.error('❌ Approve farmhouse error details:', {
...
//       return response.data.farmhouse;
//     } catch (error) {
//       console.error('Reject farmhouse error details:', {
//         status: error.response?.status,
//         data: error.response?.data,
//         message: error.message
//       });
